...
const OurFoundingStory = () => {
  return (  
    <div className='flex  flex-row w-full h-full p-36 gap-24 items-center justify-between mx-auto'>

        <div className='flex flex-col text-start text-richblack-600 w-[50%]'>
        ...
        <div className='flex items-center w-[40%] gap-2'>
            <img src={FoundationStory} alt="this is image of FoundationStory" className='gap-2 h-[278px] w-[470px]'/>
        </div>
    </div>
  )
}
